...
bool NetworkHandler::clearRemoteNpcs, NetworkHandler::fullRefresh;
...
BGSLocation* NetworkHandler::PlayerCurrentLocation;
bool NetworkHandler::HasInitialized;
string NetworkHandler::locationid, NetworkHandler::worldid;
